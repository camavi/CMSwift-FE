...
Il contenuto e derivato principalmente da `packages/ui/dist/ui.js` (`UI.meta.*`) e, quando disponibile, dal repo docs esterno `cmswift-site`.
...
- Runtime principale: `packages/ui/dist/ui.js`
- Struttura di modularizzazione pianificata: `packages/ui/src/modules.json`
- Descrizioni tutorial esterne: `cmswift-site/pages/tutorial/ui/descriptions.js`
- Esempi per componente nel repo docs: `cmswift-site/pages/tutorial/ui/*.cms.js`
- Demo entrypoint nel repo docs: `cmswift-site/pages/index.html`

## Stato Sorgenti UI

- Runtime generato: `packages/ui/dist/ui.js`
- Runtime minificato: `packages/ui/dist/min-ui.js`
- Sorgenti modulari: `packages/ui/src/`
- Migrazione: avviata, non ancora completata

Regola attuale:

- i moduli gia estratti si modificano in `packages/ui/src/`
...
- I dataset umani possono vivere in file dedicati come `cmswift-site/pages/tutorial/docs/*.doc.js`, cosi la parte narrativa resta fuori dal runtime e fuori da questo repo framework.
...
- `cmswift-site/pages/tutorial/ui/layout.cms.js`
...
_.Form(
  {
    form: registerForm,
    onSubmit: async (model) => console.log("REGISTER", model),
  },
  () => [
    _.Card(
      _.cardBody(
        ...
        _.Checkbox(
          { model: fRegisterNewsletter.model },
          "Release notes CMSwift",
        ),
        _.Checkbox(
          { model: fRegisterTerms.model },
...
- `cmswift-site/pages/tutorial/ui/form.cms.js`
...
_.Table({
  ...
  filter: (row) =>
    leadSegment.value === "all" || row.segment === leadSegment.value,
  toolbarEnd: _.div(
...
- `cmswift-site/pages/tutorial/ui/table.cms.js`
...
_.Btn(
  { onClick: (e) => releasePopover.toggle(e.currentTarget) },
  "Apri popover",
);
```
...
- `cmswift-site/pages/tutorial/ui/dialog.cms.js`
- `cmswift-site/pages/tutorial/ui/menu.cms.js`
- `cmswift-site/pages/tutorial/ui/popover.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/row.cms.js`
...
UI.meta.Row = {
  ...
  description:
    "Wrapper flex in riga con children, slot strutturati e props di layout per gap, allineamento, wrap e direction.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/col.cms.js`
...
UI.meta.Col = {
  ...
  props: {
    ...
    endClass: "string",
    slots:
      "{ start?, top?, header?, body?, content?, end?, bottom?, footer?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns: "HTMLDivElement",
  description:
    "Wrapper responsive a 24 colonne. Di default si comporta come un contenitore normale e attiva il layout flex verticale quando usi gap/allineamento, regioni strutturate o `stack`.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/spacer.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/container.cms.js`
...
UI.meta.Container = {
  ...
  props: {
    ...
    slots:
      "{ before?, header?, left?, start?, body?, content?, default?, right?, end?, footer?, after? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns: "HTMLDivElement",
  description:
    "Container composabile con max-width, spacing, layout props e sezioni opzionali.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/layout.cms.js`
...
UI.meta.Layout = {
  ...
  props: {
    ...
    overlayClass: "string",
    slots:
      "{ header?, aside?, drawer?, nav?, asideRight?, drawerRight?, page?, main?, footer?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns:
    "HTMLDivElement con methods openAside/closeAside/toggleAside/openNav/closeNav/toggleNav, " +
  ...
  description:
    "Shell layout composabile con drawer sinistro e nav destro indipendenti, width configurabili, resize opzionale con min/max, modalita floating opzionale e update runtime delle sezioni.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/header.cms.js`
...
UI.meta.Header = {
  ...
  props: {
    ...
    slots:
      "{ left?, start?, right?, end?, center?, body?, icon?, eyebrow?, title?, subtitle?, meta?, content?, actions? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns: "HTMLDivElement",
  description:
    "Header strutturato con regioni start/body/end, toggle drawer integrato, metadata e slot composabili.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/footer.cms.js`
...
UI.meta.Footer = {
  ...
  props: {
    ...
    minHeight: "string|number",
    slots:
      "{ left?, start?, right?, end?, center?, body?, icon?, eyebrow?, title?, subtitle?, meta?, content?, actions?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  description:
    "Footer strutturato con regioni start/body/end, copy opzionale, azioni e slot composabili.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/toolbar.cms.js`
...
UI.meta.Toolbar = {
  ...
  props: {
    ...
    afterClass: "string",
    slots:
      "{ before?, start?, left?, center?, body?, content?, title?, subtitle?, meta?, end?, right?, actions?, after?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  description:
    "Toolbar composabile con regioni before/start/center/end/after, copy opzionale e fallback compatibile con l'uso flex semplice.",
  returns: "HTMLDivElement",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/grid.cms.js`
...
UI.meta.Grid = {
  ...
  returns: "HTMLDivElement",
  description:
    "Griglia dichiarativa per layout responsive: supporta children, items/slot item, auto-fit, template custom e empty state.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/grid-col.cms.js`
...
UI.meta.GridCol = {
  ...
  returns: "HTMLDivElement",
  description:
    "Item per CSS Grid con span responsive, layout interno opzionale a stack, regioni start/body/end e varianti visuali leggere.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/page.cms.js`
...
UI.meta.Page = {
  ...
  props: {
    ...
    slots:
      "{ hero?, icon?, eyebrow?, title?, subtitle?, header?, aside?, body?, footer?, actions?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns: "HTMLDivElement",
  description:
    "Contenitore pagina strutturato con hero, header, body, footer e layout configurabile.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/app-shell.cms.js`
...
UI.meta.AppShell = {
  ...
  returns:
    "HTMLDivElement con methods openDrawer/closeDrawer/toggleDrawer/isDrawerOpen",
  description:
    "Shell applicazione composabile con shortcut per Header/Drawer/Page/Footer e gestione drawer.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/parallax.cms.js`
...
UI.meta.Parallax = {
  ...
  props: {
    ...
    contentClass: "string",
    slots:
      "{ background?, badge?, eyebrow?, title?, subtitle?, header?, aside?, media?, content?, footer?, actions?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  description:
    "Hero/section parallax standardizzato con header strutturato, body, actions, slots e API minima di refresh.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/card-header.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/card-body.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/card-footer.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/card.cms.js`

```js
UI.meta.Card = {
  signature: "UI.Card(...children) | UI.Card(props, ...children)",
  description:
    "Card a sezioni con header strutturato, cover/media, body e footer/actions.",
  props: {
    title: "String|Node|Function|Array",
    subtitle: "String|Node|Function|Array",
    eyebrow: "String|Node|Function|Array",
    ...
    footerClass: "string",
    slots:
      "{ identifier?, cover?, media?, icon?, eyebrow?, title?, subtitle?, header?, aside?, body?, footer?, actions?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/banner.cms.js`
...
UI.meta.Banner = {
  ...
  props: {
    ...
    stack: "boolean",
    slots:
      "{ icon?, title?, message?, description?, meta?, actions?, aside?, dismiss?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns: "HTMLDivElement",
  description:
    "Banner strutturato con tono, azioni, dismiss e slots composabili.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/badge.cms.js`
...
UI.meta.Badge = {
  ...
  props: {
    ...
    slots:
      "{ label?, default?, notification?, topLeft?, topRight?, bottomLeft?, bottomRight?, left?, right? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  description:
    "Badge inline con notification reattiva e 6 slot icona posizionabili.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/avatar.cms.js`
...
UI.meta.Avatar = {
  ...
  props: {
    ...
    statusColor:
      "success|warning|danger|info|primary|secondary|dark|light|string",
    topLeft: "Node|Function|Array",
    topRight: "Node|Function|Array",
    bottomLeft: "Node|Function|Array",
    bottomRight: "Node|Function|Array",
    slots:
      "{ media?, default?, fallback?, label?, icon?, badge?, status?, topLeft?, topRight?, bottomLeft?, bottomRight? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns: "HTMLDivElement",
  description:
    "Avatar flessibile con immagine, fallback intelligenti, stati, badge e slot overlay.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/chip.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/icon.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/list.cms.js`
...
UI.meta.List = {
  ...
  description:
    "Lista dichiarativa con supporto items, slot item, ordered/marker ed empty state.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/item.cms.js`
...
UI.meta.Item = {
  ...
  props: {
    ...
    divider: "boolean",
    slots:
      "{ icon?, title?, subtitle?, meta?, body?, aside?, actions?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  description:
    "Item strutturato per liste semplici, feed, task list e righe cliccabili.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/separator.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/form.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/form-field.cms.js`

```js
UI.meta.FormField = {
  signature: "UI.FormField(props)",
  description:
    "Wrapper field con label floating, hint/error/success/warning/note, clear e addons slot-based.",
  props: {
    ...
    wrapClass: "string",
    slots:
      "{ label?, topLabel?, prefix?, suffix?, icon?, iconRight?, clear?, hint?, error?, control? }",
  },
  slots: {
    ...
    note: "Note content",
    control:
      "Override control wrapper (ctx: { control, clear, disabled, readonly, hasValue })",
  },
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/input-raw.cms.js`
...
UI.meta.InputRaw = {
  signature: "UI.InputRaw(props)",
  description:
    "Input nativo con classe cms-input-raw, sync autofill e binding a rod/signal senza wrapper FormField.",
  props: {
  ...
  sourceNote:
    "Manual supplement: InputRaw exists in UI runtime but has no native UI.meta block in ui.js.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/input.cms.js`

```js
UI.meta.Input = {
  signature: "UI.Input(props)",
  description:
    "Field input con floating label, hint/error/success/warning/note, clearable, icon, prefix/suffix e supporto reattivo (rod/signal).",
  props: {
    // value & model
    model: "rod | [get,set] signal",
    value: "string",
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/select.cms.js`

```js
UI.meta.Select = {
  signature: "UI.Select(props)",
  description:
    "Select premium: keyboard nav, option groups, async options, filter, clearable, multi select, valori custom da filtro. Wrappato in UI.FormField.",

  props: {
    options:
      "Array<option|group> | () => Array<option|group> | async () => Promise<Array<option|group>>",
    value: "any",
    model: "rod | [get,set] signal",
  ...
  slots: {
    ...
    option:
      "Option renderer (ctx: { opt, selected, active, disabled, select })",
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/checkbox.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/radio.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/toggle.cms.js`
...
UI.meta.Toggle = {
  ...
  returns: "HTMLLabelElement",
  description:
    "Toggle switch con supporto model e comportamento checkbox/radio.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/slider.cms.js`
...
UI.meta.Slider = {
  ...
  props: {
    ...
    inputClass: "string",
    slots:
      "{ label?, default?, value?, icon?, iconRight?, thumbIcon?, thumbLabel?, marker?, markerLabel?, startLabel?, endLabel? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  description:
    "Slider reattivo con label, icone, thumb custom, markers e supporto model/QItem.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/rating.cms.js`
...
UI.meta.Rating = {
  ...
  props: {
    ...
    gap: "string|number",
    slots:
      "{ label?, icon?, checkedIcon?, uncheckedIcon?, halfIcon?, hoveredIcon?, item?, star? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns:
    "HTMLLabelElement (with ._input, ._rating, ._getValue(), ._setValue(value))",
  description:
    "Rating reattivo con label, icone custom, half rating, clearable e supporto model.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/date.cms.js`
...
UI.meta.Date = {
  ...
  props: {
    value:
      "string | { from, to } | string[] | Array<{ from, to }> | Array<[from, to]>",
    model: "rod | [get,set] signal",
  ...
  returns:
    "HTMLDivElement (field wrapper) con ._input, ._open(), ._close(), ._getValue(), ._setValue(value)",
  description:
    "Date picker reattivo con overlay fixed, single/range/multiple/multi-range, model, min/max, presets, size xs-xl e supporto opzionale al tempo in interfaccia unificata.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/time.cms.js`
...
UI.meta.Time = {
  ...
  slots: {
    option:
      "Renderer per opzione oraria ({ part, value, label, selected, timeValue })",
  ...
  returns:
    "HTMLDivElement (field wrapper) con ._input, ._open(), ._close(), ._getValue(), ._setValue(value)",
  description:
    "Time picker reattivo con overlay fixed, label/icon slots, point icon, shortcuts, confirm e model.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/tabs.cms.js`
...
UI.meta.Tabs = {
  ...
  props: {
    ...
    itemClass: "string",
    slots:
      "{ nav?, tab?, label?, icon?, note?, badge?, extra?, empty?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns:
    "HTMLDivElement con ._getValue(), ._setValue(value), ._select(value), ._next(), ._prev(), ._getTabs()",
  description:
    "Tab bar standardizzata con supporto controlled/uncontrolled, slot strutturati, badge/note/icon e navigazione tastiera.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/tap-panel.cms.js`
...
UI.meta.TabPanel = {
  ...
  props: {
    tabs: {
      ...
      description:
        "Definizione dei tab. Supporta alias multipli per label e contenuto.",
      category: "data",
    },
    items: {
      type: "Array",
    ...
    defaultValue: {
      type: "any",
      description:
        "Alias esplicito per il tab iniziale quando non usi `model`.",
      category: "data",
    },
    model: {
      type: "[get,set] signal",
    ...
    wrap: {
      type: "boolean",
      description:
        "Permette al nav di andare a capo quando lo spazio non basta.",
      default: false,
      category: "layout",
    },
    navFill: {
    ...
    transitionPrev: {
      type: "string",
      description:
        "Classi custom applicate durante la transizione verso il tab precedente.",
      category: "behavior",
    },
    transitionNext: {
      type: "string",
      description:
        "Classi custom applicate durante la transizione verso il tab successivo.",
      category: "behavior",
    },
    tabClass: {
      type: "string",
    ...
    slots: {
      ...
      description:
        "Slot strutturati per personalizzare nav, label, badge e contenuto.",
      category: "general",
    },
  },
  slots: {
    nav: {
      ...
      description:
        "Renderer completo della navigazione. Riceve `tabs`, `active()`, `activeTab()`, `select()`, `next()`, `prev()`, `nodes`, `orientation`, `position`, `variant`.",
    },
    tab: {
      type: "Function|Node|Array",
      description:
        "Contenuto interno del bottone tab. Riceve `tab`, `name`, `index`, `active`, `label`, `icon`, `note`, `badge`, `select()`.",
    },
    label: {
      type: "Function|Node|Array",
    ...
    panel: {
      type: "Function|Node|Array",
      description:
        "Renderer del pannello attivo/inattivo. Riceve `tab`, `name`, `index`, `active`, `select()`, `next()`, `prev()`.",
    },
    empty: {
      type: "Function|Node|Array",
  ...
  returns:
    "HTMLDivElement con API `_getValue()`, `_setValue(value)`, `_select(value)`, `_next()`, `_prev()`, `_active()`, `_tabs()`",
  description:
    "Tab panel standardizzato con nav accessibile, slot strutturati, model reattivo, swipe e animazioni.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/route-tab.cms.js`
...
UI.meta.RouteTab = {
  ...
  returns:
    "HTMLAnchorElement con ._isActive(), ._setActive(boolean|null), ._navigate(event?)",
  description:
    "Tab/link standardizzato per navigazione router o href, con slot strutturati, stati e badge.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/breadcrumbs.cms.js`
...
UI.meta.Breadcrumbs = {
  ...
  props: {
    items:
      "Array<string|number|Node|Function|{ label?, to?, href?, icon?, note?, badge?, current?, disabled?, hidden?, slots? }>",
  ...
  returns:
    "HTMLElement <nav> con .getItems(), .getVisibleItems(), .refresh(), .setItems(items)",
  description:
    "Breadcrumbs standardizzati con item strutturati, slot completi, collapse automatico e supporto a link/router.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/pagination.cms.js`
...
UI.meta.Pagination = {
  ...
  props: {
    ...
    slots:
      "{ start?, end?, first?, prev?, page?, item?, ellipsis?, next?, last?, summary?, label? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  description:
    "Paginazione standard con controlli edge, numeri, ellissi, summary e supporto total/pageSize.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/spinner.cms.js`
...
UI.meta.Spinner = {
  ...
  returns: "HTMLDivElement",
  description:
    "Spinner animato con layout flessibile, contenuti opzionali e controllo di dimensioni, velocita e traccia.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/progress.cms.js`
...
UI.meta.Progress = {
  ...
  props: {
    ...
    reverse: "boolean",
    slots:
      "{ icon?, label?, note?, value?, inside?, startLabel?, endLabel?, default? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns: "HTMLDivElement",
  description:
    "Progress bar standardizzata con header opzionale, buffer, stato semantico e supporto reattivo.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/loading-bar.cms.js`
...
UI.meta.LoadingBar = {
  ...
  returns:
    "HTMLDivElement con API imperativa: .set(), .setBuffer(), .inc(), .start(), .done(), .stop(), .reset(), .show(), .hide(), .destroy()",
  description:
    "Loading bar basata su UI.Progress, montabile su body o container custom, controllabile via model o API imperativa.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/table.cms.js`
...
UI.meta.Table = {
  ...
  props: {
    columns:
      "Array<{ key, label?, sortable?, get?, value?, render?, format?, width?, minWidth?, maxWidth?, align?, compare?, style?, headerStyle?, thStyle?, cellStyle?, tdStyle?, cellClass?, headerClass?, nowrap?, searchable? }>",
    rows: "Array|() => Array",
  ...
  returns: "HTMLDivElement",
  description:
    "Tabella standardizzata con toolbar, ricerca, sorting, paginazione, stati e rendering flessibile.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/tooltip.cms.js`
...
UI.meta.Tooltip = {
  ...
  returns:
    "Object { bind(), open(), show(), hide(), close(), toggle(), isOpen() } | HTMLSpanElement",
  description:
    "Tooltip ancorato con trigger hover/focus/click, contenuto ricco e API imperativa.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/drawer.cms.js`
...
UI.meta.Drawer = {
  ...
  props: {
    ...
    sticky: "boolean",
    slots:
      "{ header?, body?, footer?, before?, after?, empty?, item?, itemLabel?, itemNote?, itemBadge?, itemAside?, itemContent?, group?, groupLabel?, groupNote?, groupBadge?, groupAside?, groupContent?, sectionLabel? }",
    class: "string",
    style: "object",
  },
  slots: {
  ...
  returns:
    "HTMLDivElement con methods openDrawer/closeDrawer/toggleDrawer/isDrawerOpen",
  description:
    "Drawer strutturato e retro compatibile con header/footer, gruppi, slot estesi, empty state e stato persistente.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/dialog.cms.js`

```js
UI.meta.Dialog = {
  signature:
    "UI.Dialog(props) | UI.Dialog(props, ...children) -> { open, close, toggle, update, isOpen }",
  props: {
    ...
    closeOnEsc: "boolean",
    slots:
      "{ icon?, eyebrow?, title?, subtitle?, header?, content?, body?, footer?, actions?, close?, default? }",
    class: "string",
    panelClass: "string",
    overlayClass: "string",
    style: "object",
  ...
  description:
    "Dialog overlay standardizzato con varianti, animazioni, slots strutturati e API imperativa.",
  returns:
    "Object { open(overrides?), close(), toggle(overrides?), update(props), isOpen(), entry(), props() }",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/menu.cms.js`

```js
UI.meta.Menu = {
  signature:
    "UI.Menu(props) | UI.Menu(props, ...children) -> { open, close, show, hide, toggle, update, bind, isOpen }",
  props: {
    title: "String|Node|Function|Array|({ close })=>Node",
    subtitle: "String|Node|Function|Array|({ close })=>Node",
    eyebrow: "String|Node|Function|Array|({ close })=>Node",
    ...
    slots:
      "{ before?, icon?, eyebrow?, title?, subtitle?, header?, content?, body?, item?, itemTitle?, itemSubtitle?, itemBadge?, itemShortcut?, groupLabel?, empty?, status?, footer?, after?, default? }",
    class: "string",
    panelClass: "string",
    overlayClass: "string",
    style: "object",
  ...
  returns:
    "Object { open(), close(), show(), hide(), toggle(), update(), bind(), isOpen() }",
  description:
    "Menu overlay standardizzato con item model, slot ricchi, trigger bindabili, header/footer e API imperativa.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/popover.cms.js`

```js
UI.meta.Popover = {
  signature:
    "UI.Popover(props) | UI.Popover(props, ...children) -> { open, close, show, hide, toggle, update, bind, isOpen }",
  props: {
    title: "String|Node|Function|Array|({ close })=>Node",
    subtitle: "String|Node|Function|Array|({ close })=>Node",
    eyebrow: "String|Node|Function|Array|({ close })=>Node",
  ...
  returns:
    "Object { open(), close(), show(), hide(), toggle(), update(), bind(), isOpen() }",
  description:
    "Popover ancorato standardizzato con layout ricco, slot completi, trigger bindabili e API imperativa.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/context-menu.cms.js`

```js
UI.meta.ContextMenu = {
  signature:
    "UI.ContextMenu(props) | UI.ContextMenu(props, ...children) -> { open, openAt, openFromEvent, show, hide, close, toggle, update, bind, isOpen }",
  props: {
    title: "String|Node|Function|Array|({ close })=>Node",
    subtitle: "String|Node|Function|Array|({ close })=>Node",
    eyebrow: "String|Node|Function|Array|({ close })=>Node",
  ...
  returns:
    "Object { open(), openAt(), openFromEvent(), show(), hide(), close(), toggle(), update(), bind(), isOpen() }",
  description:
    "Specializzazione di Menu per click destro e tasto context menu, con items, slot ricchi, runtime overrides e posizionamento su coordinate.",
};
```
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/btn.cms.js`
...
- Runtime source: `packages/ui/dist/ui.js`
- Tutorial / sample source: `cmswift-site/pages/tutorial/ui/notify.cms.js`

```js
UI.meta.Notify = {
  signature: "UI.Notify(message, title?, opts?) | UI.Notify(opts, ...children)",
  description:
    "Notify standardizzato con payload strutturato, shortcut semantiche, update/remove/clear e supporto promise.",
  props: {
    id: "string",
    ...
    slots:
      "{ icon?, title?, message?, description?, meta?, actions?, dismiss?, default? }",
  },
  methods: {
...
- Per esempi completi apri i file in `cmswift-site/pages/tutorial/`: il README serve come reference veloce, i tutorial mostrano combinazioni realistiche dei componenti.
