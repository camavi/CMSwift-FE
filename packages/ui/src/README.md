...
- il monolite `ui.js` e stato spezzato in moduli sotto `packages/ui/src/*`
- `99-legacy-ui.js` non e piu usato nella build
- l'output runtime pubblico ora esce in `packages/ui/dist/`
- un mirror legacy resta in `pages/_cmswift-fe/js/`
...
- asset CSS/font/img in `packages/ui/dist/`
...
- poi si rigenera il package UI
- poi si verifica con demo/tutorial rilevanti
- infine si aggiorna `docs/reference/ui.md`

Nota:

- da questo punto la source of truth e `packages/ui/src/`
